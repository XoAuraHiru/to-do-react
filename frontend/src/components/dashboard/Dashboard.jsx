...
const Dashboard = () => {
  ...
  const handleEditTask = async (taskId) => {
    ...
    setState((prev) => ({
      ...prev,
      tasks: result.success
        ? prev.tasks.map((task) => (task._id === taskId ? result.task : task))
        : prev.tasks,
      editingTask: null,
      error: result.success ? "" : result.error,
    }));
      ...
      <Card className="max-w-4xl mx-auto">
        ...
        <CardContent>
          ...
          <TaskForm
            ...
            onTaskChange={(value) =>
              setState((prev) => ({ ...prev, newTask: value }))
            }
            onDateChange={(value) =>
          ...
          <TaskList
            ...
            onEditDateChange={(value) =>
              setState((prev) => ({ ...prev, editDate: value }))
            }
            onEditTimeChange={(value) =>
              setState((prev) => ({ ...prev, editTime: value }))
            }
